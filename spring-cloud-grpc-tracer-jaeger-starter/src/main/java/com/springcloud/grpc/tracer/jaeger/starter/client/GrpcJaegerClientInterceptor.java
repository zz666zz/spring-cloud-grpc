...
public class GrpcJaegerClientInterceptor implements ClientInterceptor {
     ...
     * @param
     */
    public GrpcJaegerClientInterceptor(Tracer tracer) {
        this.tracer=tracer;
    ...
    private GrpcJaegerClientInterceptor(Tracer tracer, OperationNameConstructor operationNameConstructor, boolean streaming,
    ...
    public static class Builder {
         ...
         */
        public GrpcJaegerClientInterceptor build() {
            return new GrpcJaegerClientInterceptor(this.tracer, this.operationNameConstructor,
