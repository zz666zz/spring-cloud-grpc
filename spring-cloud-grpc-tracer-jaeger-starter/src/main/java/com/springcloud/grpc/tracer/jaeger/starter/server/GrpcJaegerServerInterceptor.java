...
import com.springcloud.grpc.tracer.jaeger.starter.common.OpenTracingContextKey;
 ...
 */
public class GrpcJaegerServerInterceptor implements ServerInterceptor {
    ...
    public GrpcJaegerServerInterceptor(Tracer tracer) {
        this.tracer = tracer;
    ...
    private GrpcJaegerServerInterceptor(Tracer tracer, OperationNameConstructor operationNameConstructor, boolean streaming,
    ...
    public static class Builder {
         ...
         */
        public GrpcJaegerServerInterceptor build() {
            return new GrpcJaegerServerInterceptor(this.tracer, this.operationNameConstructor,
